      ...
      <div className="absolute inset-0">
       ...
       "
        ...
        <div className="overflow-hidden h-[450px] w-full relative">
          ...
          <img
            src={`
            ${import.meta.env.VITE_CLOUDINARY_ASSETS_URL}/Online.webp`}
            alt=""
            className="mx-auto max-w-[1120px]  w-full h-full object-cover object-bottom -scale-x-100"
          ...
          {!showPreloader && (
            <img
              ...
              alt=""
              className="h-full w-full absolute inset-0 mx-auto max-w-[1120px]"
            />
          )}
          <div className="max-w-[1700px] mx-auto relative">
            ...
            <div className="absolute text-white xsm:bottom-40 bottom-36 lg:left-20 sm:left-10 left-5 tracking-wide  max-w-[1700px] mx-auto">
